...
namespace Framework.Service.Builders
{
    /// <summary>
    /// 
    /// </summary>
    public class ResponseBuilder<T> : IResponseBuilder<T>
    {
        ...
        public ResponseBuilder()
        {
            ...
            _aPIResponse.Errors = new List<Framework.Service.DTO.Error.Error>();
        ...
        public ResponseBuilder<T> AddSuccessData(T data)
        {
            ...
            this.AddMessage(ResponseConstants.Success);
            return this;
        }
        ...
        public ResponseBuilder<T> AddError(Error error)
        {
            ...
            this.AddMessage(ResponseConstants.ErrorMessage);
            return this;
        }
